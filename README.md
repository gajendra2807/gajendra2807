...
**Full-stack & mobile developer** with **3+ years** of full-time
experience, shipping web and mobile apps end to end.

- 📱 I take mobile apps **from scratch to the App Store & Google Play** — design, build, deploy.
- 🧩 Comfortable across the whole stack — **UI, API, database and release.**
- 💬 Ask me about **TypeScript · Next.js · Vue · Python · Supabase**.
- 📫 **gajendrajadaun2807@gmail.com**
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=ts,js,react,nextjs,vue,python,nodejs,supabase,postgres,tailwind,html,css,git,github,vscode&perline=15" alt="skills"/>
</p>
<p align="center"><sub>📱 Mobile delivery: iOS &amp; Android &nbsp;·&nbsp; App&nbsp;Store &amp; Google&nbsp;Play</sub></p>
...
| :--- | :--- | :--- |
| 🌐 **[Portfolio](https://gajendra-myportfolio.netlify.app/)** · _live_ | My personal portfolio site | HTML · CSS · JavaScript |
| 🌦️ **[weather_app](https://github.com/gajendra2807/weather_app)** | Weather forecast app | Vue |
| 🛍️ **[beach_shop](https://github.com/gajendra2807/beach_shop)** | E-commerce storefront | Vue |
| 🎙️ **[transcribe_audio](https://github.com/gajendra2807/transcribe_audio)** | Audio transcription tool | Python |
